...
import 'package:tagxisuperuser/pages/login/otp_page.dart';
import 'package:tagxisuperuser/pages/onTripPage/booking_confirmation.dart';
import 'package:tagxisuperuser/pages/login/get_started.dart';
import 'package:tagxisuperuser/pages/login/login.dart';
import 'package:tagxisuperuser/pages/onTripPage/map_page.dart';
import 'package:tagxisuperuser/pages/onTripPage/review_page.dart';
import 'package:tagxisuperuser/pages/referralcode/referral_code.dart';
...
verifyUser(String number) async {
  ...
  try {
    var response = await http.post(
        ...
        body: (value == 0) ? {"mobile": number} : {"email": email});
    if (response.statusCode == 200) {
