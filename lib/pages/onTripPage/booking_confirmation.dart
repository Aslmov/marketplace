...
import 'package:tagxisuperuser/pages/NavigatorPages/pickcontacts.dart';
import 'package:tagxisuperuser/pages/chatPage/chat_page.dart';
import 'package:tagxisuperuser/pages/login/login.dart';
import 'package:tagxisuperuser/pages/onTripPage/choosegoods.dart';
                                                                                ...
                                                                                child: Column(
                                                                                  children: [
                                                                                    SizedBox(
                                                                                      ...
                                                                                      child: Image.asset('assets/images/cancel.png', color: textColor),
                                                                                    ),
                                                                                    SizedBox(
                                                                                      height: media.width * 0.02,
                                                                                    ),
                                                                          ...
                                                                          children: [
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                child: Row(
                                                                                  children: [
                                                                                    ...
                                                                                    SizedBox(height: media.width * 0.07, child: (addressList.length > 2) ? Icon(Icons.move_down_rounded, size: media.width * 0.05, color: textColor) : Icon(Icons.edit, size: media.width * 0.05, color: textColor))
                                                                                  ],
                                                                                ),
                                                                              ),
                                                                            ),
                                                                            (addressList.length > 2)
                                                                                ? InkWell(
                                                                                    ...
                                                                                    child: Icon(Icons.delete, size: media.width * 0.07, color: textColor))
                                                                                : Container()
                                                                          ],
                                                                        ),
                                                                      )
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Container(
                                                                              height: media.width * 0.12,
                                                                              width: media.width * 0.12,
                                                                              decoration: BoxDecoration(borderRadius: (languageDirection == 'ltr') ? const BorderRadius.only(topLeft: Radius.circular(10), bottomLeft: Radius.circular(10)) : const BorderRadius.only(topRight: Radius.circular(10), bottomRight: Radius.circular(10)), color: (isDarkTheme == true) ? textColor : const Color(0xff222222)),
                                                                              alignment: Alignment.center,
                                                                              child: const Icon(
                                                                                Icons.star,
