...
import 'utils/FlutterSlider.dart';
  ...
  Widget build(BuildContext context) {
                                ...
                                (i, e) => MapEntry(
                                  ...
                                  Tooltip(
                                    ...
                                    child: InkWell(
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(10)), color: isDarkTheme ? food_colorPrimary : food_view_color),
    ...
    return Scaffold(
      ...
      appBar: appBarWidget(
        ...
        actions: [
          IconButton(
            icon: Icon(Icons.filter_list, color: isDarkTheme ? white : black),
            onPressed: () {
              mFilter();
            },
          ),
