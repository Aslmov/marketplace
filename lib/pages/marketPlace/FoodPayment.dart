...
class FoodPaymentState extends State<FoodPayment> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget mPaymentOption(var icon, var heading, var value, var valueColor) {
      return Container(
        decoration: BoxDecoration(boxShadow: defaultBoxShadow(), color: isDarkTheme ? scaffoldDarkColor : white),
        ...
        child: Column(
          children: <Widget>[
            ...
            Text(value, style: primaryTextStyle(color: isDarkTheme ? white : valueColor)),
          ],
        ),
      );
    }
      ...
      return Column(
        children: <Widget>[
          Stack(
            ...
            children: <Widget>[
              Image.asset(food_ic_fab_back, width: width * 0.17, color: isDarkTheme ? scaffoldDarkColor : white),
              Container(
                          ...
                          RichText(
                            text: TextSpan(
                              children: [
                                ...
                                TextSpan(text: food_lbl__42xx_4523_xxxx_55xx, style: primaryTextStyle(size: 16, color: isDarkTheme ? white : food_textColorPrimary)),
                              ],
                            ),
                          ),
                        ],
