          ...
          WidgetSpan(
              child: Padding(
                  ...
                  child: Icon(Icons.search,
                      color: appTextColorSecondary, size: 18))),
          TextSpan(
              text: languages[choosenLanguage]['text_search_resto'],
              style: TextStyle(
                  fontSize: 16, color: const Color.fromARGB(255, 63, 60, 60))),
        ],
      ),
    ),
  );
...
Widget mAddress(BuildContext context) {
  return Container(
    ...
    decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(50),
        color: isDarkTheme ? cardDarkColor : food_colorPrimary_light),
    child: Row(
                  ...
                  text: TextSpan(
                    children: [
                      ...
                      TextSpan(
                          ...
                          style: TextStyle(
                              fontSize: 16, color: food_colorPrimary)),
                    ],
                  ),
                ),
                Container(
      ...
      child: RichText(
        text: TextSpan(
          children: [
            ...
            TextSpan(
                text: value,
                style: primaryTextStyle(size: 16, color: food_colorPrimary)),
          ],
        ),
      ),
    ),
  ...
  return RichText(
    text: TextSpan(
      children: [
        TextSpan(
            text: value,
            style: primaryTextStyle(size: 14, color: food_color_green)),
        WidgetSpan(
          child: Padding(
            padding: const EdgeInsets.symmetric(horizontal: 4.0),
            child: Icon(Icons.radio_button_checked,
                color: food_color_green, size: 16),
          ),
        ),
      ],
    ),
          ...
          children: <Widget>[
            ...
            Text("$count",
                style: primaryTextStyle(
                    color: isDarkTheme ? white : food_textColorPrimary)),
            Container(
              width: width * 0.08,
              height: width * 0.08,
              alignment: Alignment.center,
        ...
        Column(
          ...
          children: <Widget>[
            Padding(
              ...
              child: Text(food_lbl_1799, style: primaryTextStyle(size: 18)),
            ),
            Text(food_lbl_view_bill_details,
                style: primaryTextStyle(color: food_colorPrimary)),
          ],
        ),
        GestureDetector(
            ...
            child: RichText(
              ...
              text: TextSpan(
                children: [
                  TextSpan(
                      text: value,
                      style: primaryTextStyle(size: 12, color: food_white)),
                  WidgetSpan(
                    child: Padding(
                        padding: EdgeInsets.only(left: 4),
                        child: Icon(Icons.arrow_forward,
                            color: food_white, size: 16)),
                  ),
                ],
              ),
            ),
  ...
  return AppBar(
    ...
    leading: showBack
        ? IconButton(
            ...
            icon: Icon(Icons.arrow_back, color: isDarkTheme ? white : black),
          )
        : null,
    title:
...
Widget placeholderWidget() =>
    Image.asset('assets/images/marketPlace/grey.png', fit: BoxFit.cover);
