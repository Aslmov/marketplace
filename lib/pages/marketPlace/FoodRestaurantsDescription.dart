...
class FoodRestaurantsDescriptionState extends State<FoodRestaurantsDescription> {
  ...
  void dispose() {
    super.dispose();
    changeStatusColor(isDarkTheme ? Colors.black : Colors.white);
  }
      ...
      return RichText(
        text: TextSpan(
          children: [
            ...
            TextSpan(text: value, style: primaryTextStyle(size: 16, color: isDarkTheme ? white : food_textColorPrimary)),
          ],
        ),
      );
    }
    ...
    Widget mGallery(var icon, var value) {
      return RichText(
        text: TextSpan(
          children: [
            WidgetSpan(
              child: Padding(padding: EdgeInsets.only(right: 8), child: Icon(icon, color: isDarkTheme ? white : food_textColorPrimary, size: 18)),
            ),
            TextSpan(text: value, style: primaryTextStyle(size: 16, color: isDarkTheme ? white : food_textColorPrimary)),
          ],
        ),
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        children: <Widget>[
                          IconButton(
                            icon: Icon(Icons.favorite_border, color: isDarkTheme ? white : food_textColorPrimary),
                            onPressed: () {},
                          ),
                          IconButton(
                            icon: Icon(Icons.search, color: isDarkTheme ? white : food_textColorPrimary),
                            onPressed: () {},
                          ),
                        ],
                      ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(height: 16),
                      Container(
                        decoration: BoxDecoration(color: isDarkTheme ? cardDarkColor : food_color_light_orange),
                        padding: EdgeInsets.all(8),
                        child: Row(
                          children: <Widget>[
                            RichText(
