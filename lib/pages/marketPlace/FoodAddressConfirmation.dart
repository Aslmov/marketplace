...
class FoodAddressConfirmationState extends State<FoodAddressConfirmation> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: isDarkTheme ? cardDarkColor : food_view_color,
      body: SafeArea(
        child: Stack(
          children: <Widget>[
            MapPage(),
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        Expanded(
                          ...
                          child: Container(
                            padding: EdgeInsets.only(top: 4, bottom: 4),
                            decoration: BoxDecoration(border: Border.all(color: food_colorPrimary), borderRadius: BorderRadius.circular(50), color: isDarkTheme ? scaffoldDarkColor : white),
