              ...
              children: <Widget>[
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(shape: BoxShape.circle, color:  isDarkTheme ? scaffoldDarkColor : food_white),
                    width: width * 0.13,
                    height: width * 0.13,
                    child: Icon(Icons.arrow_forward, color: isDarkTheme ? white : food_textColorPrimary),
                  ),
                ),
                Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      mOption(isDarkTheme ? black : food_white, food_ic_google_fill, food_lbl_google, isDarkTheme ? white : food_color_red,
                          isDarkTheme ? white : food_textColorPrimary),
