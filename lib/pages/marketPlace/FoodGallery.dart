...
import 'package:tagxisuperuser/models/marketPlaceModels/FoodModel.dart';
import 'package:tagxisuperuser/pages/marketPlace/utils/FoodColors.dart';
import 'package:tagxisuperuser/pages/marketPlace/utils/FoodDataGenerator.dart';
import 'package:tagxisuperuser/pages/marketPlace/utils/FoodString.dart';
import 'package:tagxisuperuser/pages/marketPlace/utils/FoodWidget.dart';
        ...
        child: DefaultTabController(
          ...
          child: Scaffold(
            appBar: PreferredSize(
              ...
              child: SafeArea(
                child: Container(
                    color: isDarkTheme ? scaffoldDarkColor : food_app_background,
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: IconButton(
                            icon: Icon(Icons.arrow_back, color: isDarkTheme ? white : food_icon_color),
                            onPressed: () {
