...
Color textColor = const Color(0xff080808);
Color backIcon = const Color(0xff080808);
Color underline = const Color(0xff080808).withOpacity(0.3);
Color hintColor = const Color(0xff080808).withOpacity(0.3);
Color inputUnderline = const Color(0xff080808).withOpacity(0.3);
Color inputfocusedUnderline = const Color(0xff080808);
Color topBar = const Color(0xffFFFFFF);
Color page = const Color(0xffFFFFFF);
Color buttonColor = const Color(0xffdc5d2a);
Color buttonText = const Color(0xffFFFFFF);
Color theme = const Color(0xffdc5d2a);
Color inputFieldSeparator = const Color(0xff1DA1F2);
Color termsCheckBox = const Color(0xff39BF4E);
Color loaderColor = const Color(0xfffbce01);
Color notUploadedColor = Colors.orange;
Color verifyPendingBck = const Color(0xffFEF2F2);
Color verifyPending = const Color(0xfffbce01);
...
Color starColor = const Color(0xffdc5d2a);
Color navText = Colors.black;
 Color  orange = Color(0xFFFC6011);
Color    primary = Color(0xFF4A4B4D);
 Color secondary = Color(0xFF7C7D7E);
 Color   placeholder = Color(0xFFB6B7B7);
 Color placeholderBg = Color(0xFFF2F2F2);
